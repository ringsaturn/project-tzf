...
description: "Best practices, patterns, and advanced usage for tzf implementations across Go, Rust, and Python."
summary: ""
...
For installation and basic usage, see [Getting Started]({{< relref "../getting-started" >}}).
